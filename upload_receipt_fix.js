...
async function main() {
  console.log('Uploading missing Receipt icon import fix in Sidebar...');
  await uploadFile(
    'apps/web/src/components/Sidebar.jsx',
    'apps/web/src/components/Sidebar.jsx',
    'fix: add missing Receipt icon import to Sidebar.jsx to resolve dashboard error'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for receipt icon import fix');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-CCkM4SOj.js', 'dist/apps/web/assets/index-CCkM4SOj.js', 'chore: update dist JS bundle');

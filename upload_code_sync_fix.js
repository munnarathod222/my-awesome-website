...
async function main() {
  console.log('Uploading 100% exact employee code synchronization fix...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'fix: preserve exact employee_number from profile database on ID card'
  );
  await uploadFile(
    'apps/web/src/pages/EmployeeDatabasePage.jsx',
    'apps/web/src/pages/EmployeeDatabasePage.jsx',
    'fix: ensure employee database profile and edit form maintain exact D001/E001 codes'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for code sync fix');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-DCZXF6ft.js', 'dist/apps/web/assets/index-DCZXF6ft.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ Employee code synchronization fix uploaded!');
}

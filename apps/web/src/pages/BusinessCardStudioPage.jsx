...
export default function BusinessCardStudioPage({ embedMode = false }) {
  ...
  const [cardData, setCardData] = useState({
    ...
    email: companyProfile?.company_email || 'operations@jaibhavanicargo.com',
    website: companyProfile?.company_website || 'www.jaibhavanicargo.com',
    address: companyProfile?.company_address || 'Plot No. 3, Patel Nagar, Ghatkesar, Medchal-Malkajgiri Dist., Telangana - 501301',

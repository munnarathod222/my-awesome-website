...
async function main() {
  console.log('Uploading Print CSS Padding & Aspect Ratio Fit Fixes for Letterhead Studio...');
  await uploadFile(
    'apps/web/src/pages/OfficialLetterheadPage.jsx',
    'apps/web/src/pages/OfficialLetterheadPage.jsx',
    'fix: preserve slider padding in print CSS, add image fit selector, hide navigation in print'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for print padding & image fit fix');
  console.log('Uploading JS bundle (5.0MB)...');
  await uploadFile('dist/apps/web/assets/index-Bw0y0iTp.js', 'dist/apps/web/assets/index-Bw0y0iTp.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-ByrYPrv-.css', 'dist/apps/web/assets/index-ByrYPrv-.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Print CSS & Aspect Ratio fixes uploaded successfully!');
}

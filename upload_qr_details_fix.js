...
async function main() {
  console.log('Uploading QR code verification details accuracy fix...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'fix: encode active employee attributes into QR verification URL parameters'
  );
  await uploadFile(
    'apps/web/src/pages/EmployeeQRVerificationPage.jsx',
    'apps/web/src/pages/EmployeeQRVerificationPage.jsx',
    'fix: parse URL parameters and eliminate hardcoded fallback identity'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for QR details accuracy fix');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-CBtj9zs9.js', 'dist/apps/web/assets/index-CBtj9zs9.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ QR verification accuracy fix uploaded!');
}

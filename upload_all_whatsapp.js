...
async function main() {
  ...
  await uploadFile(
    ...
    'apps/web/src/components/WhatsAppShareModal.jsx',
    'feat: full WhatsApp sharing suite (Quote, Invoice, Booking Confirmation with Driver & Vehicle Details, Trip Status, POD)'
  );
  await uploadFile(
    'apps/web/src/pages/TripLogsPage.jsx',
    'apps/web/src/pages/TripLogsPage.jsx',
    'feat: update trip row WhatsApp share menu with all templates'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist for full WhatsApp suite');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-Dt1L3Bf8.js', 'dist/apps/web/assets/index-Dt1L3Bf8.js', 'chore: update dist JS bundle');

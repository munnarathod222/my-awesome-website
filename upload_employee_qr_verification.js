...
async function main() {
  console.log('Uploading Employee QR Verification public page & routes...');
  await uploadFile(
    'apps/web/src/pages/EmployeeQRVerificationPage.jsx',
    'apps/web/src/pages/EmployeeQRVerificationPage.jsx',
    'feat: create EmployeeQRVerificationPage.jsx for public ID card QR code verification'
  );
  await uploadFile(
    'apps/web/src/App.jsx',
    'apps/web/src/App.jsx',
    'feat: register /verify-employee/:empId and /v/emp/:empId public routes in App.jsx'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for employee QR verification');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-CD-YFTzS.js', 'dist/apps/web/assets/index-CD-YFTzS.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-CyplyMF9.css', 'dist/apps/web/assets/index-CyplyMF9.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Employee QR Verification feature uploaded!');
}

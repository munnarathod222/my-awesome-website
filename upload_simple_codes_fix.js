...
async function main() {
  console.log('Uploading Simple D001 / E001 Driver and Employee code formatting...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'feat: format driver codes as D001/D002 and employee codes as E001/E002 in ID card generator'
  );
  await uploadFile(
    'apps/web/src/pages/EmployeeDatabasePage.jsx',
    'apps/web/src/pages/EmployeeDatabasePage.jsx',
    'feat: update employee database form & table code generator to D001 for drivers and E001 for staff'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for D001/E001 codes');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-j78vKM56.js', 'dist/apps/web/assets/index-j78vKM56.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-CMGurJ_M.css', 'dist/apps/web/assets/index-CMGurJ_M.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Simple D001 & E001 Code formatting uploaded!');
}

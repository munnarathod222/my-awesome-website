...
async function main() {
  console.log('Uploading Curved Wave Executive Template with Company Settings Logo...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'feat: add Curved Wave Executive template with company settings logo integration'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for curved wave template');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-CEfv2fax.js', 'dist/apps/web/assets/index-CEfv2fax.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ Curved Wave Template feature uploaded!');
}

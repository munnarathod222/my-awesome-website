...
e.jsxs("div",{className:"p-3.5 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-3",children:[
  ...
  return e.jsxs(e.Fragment,{children:[
    ...
    e.jsx("div",{className:"flex-1 overflow-y-auto my-3 bg-slate-950 p-2 rounded-2xl border border-slate-800 flex flex-col items-center justify-center min-h-[420px]",children:curUrl?curUrl.match(/\.(jpeg|jpg|gif|png|webp)($|\?)/i)||c.file_name?.match(/\.(jpeg|jpg|gif|png|webp)$/i)?e.jsxs("div",{className:"relative flex flex-col items-center justify-center w-full my-auto",children:[e.jsx("img",{src:curUrl,alt:c.title,className:"max-h-[60vh] object-contain rounded-xl border border-slate-800 shadow-lg",onError:function(E){E.currentTarget.style.display="none";var fb=E.currentTarget.nextElementSibling;if(fb)fb.style.display="flex";}}),e.jsxs("div",{style:{display:"none"},className:"flex flex-col items-center justify-center text-center p-8 bg-slate-900/90 rounded-2xl border border-dashed border-amber-500/40 max-w-md w-full my-auto space-y-4 shadow-xl",children:[e.jsx("div",{className:"w-14 h-14 rounded-full bg-amber-500/20 text-amber-400 border border-amber-500/30 flex items-center justify-center text-2xl font-bold",children:"⚠️"}),e.jsx("h4",{className:"text-base font-bold text-white mb-1",children:"Document Image Missing from Server"}),e.jsx("p",{className:"text-xs text-slate-300 leading-relaxed mb-3",children:"This document file was cleared during a cloud container reset. You can attach or replace the document image now."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-2.5 w-full pt-1",children:[e.jsx("button",{onClick:function(){de(null);setPreviewSide("front");handleOpenEdit(c);},className:"flex-1 py-2.5 px-4 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold text-xs flex items-center justify-center gap-1.5 shadow-lg transition-all cursor-pointer",children:"📁 Upload / Replace License Image"})]})]})]}):curUrl.match(/\.pdf($|\?)/i)||c.file_name?.match(/\.pdf$/i)?e.jsx("iframe",{src:curUrl,title:c.title,className:"w-full h-[60vh] rounded-xl border border-slate-800 bg-white"}):e.jsxs("div",{className:"text-center p-8 space-y-4",children:[e.jsx(te,{className:"w-16 h-16 text-primary mx-auto opacity-60"}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm font-bold text-white",children:previewSide==="back"?"Back Side Document":(c.file_name||c.title)}),e.jsxs("p",{className:"text-xs text-slate-400 mt-1",children:["This document is stored securely in Company Vault."]})]}),e.jsxs("div",{className:"flex items-center justify-center gap-3 pt-2",children:[e.jsxs(n,{onClick:()=>ye({file_url:curUrl,title:previewSide==="back"?`${c.title}_Back`:`${c.title}_Front`}),className:"bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl px-4 py-2 shadow-lg shadow-emerald-500/20",children:[e.jsx(ue,{className:"w-4 h-4 mr-2"})," Download This Side"]}),e.jsxs(n,{variant:"outline",onClick:()=>window.open(curUrl,"_blank"),className:"border-slate-700 text-slate-200 hover:bg-slate-800 text-xs rounded-xl",children:[e.jsx(_e,{className:"w-4 h-4 mr-2"})," Open in Browser"]})]})]}):e.jsx("p",{className:"text-xs text-slate-400",children:"No file URL available for preview"})}),

...
async function main() {
  console.log('Uploading Trip Logs Page useAuth missing import fix...');
  await uploadFile(
    'apps/web/src/components/AddRecurringTripModal.jsx',
    'apps/web/src/components/AddRecurringTripModal.jsx',
    'fix: import missing useAuth in AddRecurringTripModal to resolve Trip Logs render error'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for triplogs useAuth fix');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-DaQ4kJbk.js', 'dist/apps/web/assets/index-DaQ4kJbk.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ Trip Logs useAuth fix uploaded!');
}

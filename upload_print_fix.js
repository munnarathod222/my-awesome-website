...
async function main() {
  ...
  await uploadFile(
    ...
    'apps/web/src/index.css',
    'fix: ensure 100% print to preview visual fidelity for payslips and documents'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist for 100% print match');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-mkIS6Ehr.js', 'dist/apps/web/assets/index-mkIS6Ehr.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ All print fidelity updates uploaded!');
}

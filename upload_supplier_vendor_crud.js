...
async function main() {
  console.log('Uploading Supplier Vendor Edit/Delete feature...');
  await uploadFile(
    'apps/web/src/pages/VendorTrackerPage.jsx',
    'apps/web/src/pages/VendorTrackerPage.jsx',
    'feat: add edit, delete & intel modal for supply vendors in VendorTrackerPage'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html');
  console.log('Uploading JS bundle...');
  await uploadFile('dist/apps/web/assets/index-BN_xQbeB.js', 'dist/apps/web/assets/index-BN_xQbeB.js', 'chore: update dist JS bundle for supplier vendor edit/delete');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-CRjBXDvv.css', 'dist/apps/web/assets/index-CRjBXDvv.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Supplier Vendor Edit/Delete feature deployed successfully!');
}

...
async function main() {
  console.log('Uploading missing Switch import fix in AddTripModal...');
  await uploadFile(
    'apps/web/src/components/AddTripModal.jsx',
    'apps/web/src/components/AddTripModal.jsx',
    'fix: add missing Switch component import in AddTripModal to fix dashboard rendering error'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for dashboard switch fix');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-CpWQ-Zt3.js', 'dist/apps/web/assets/index-CpWQ-Zt3.js', 'chore: update dist JS bundle');

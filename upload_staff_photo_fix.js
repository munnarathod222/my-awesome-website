...
async function main() {
  console.log('Uploading staff & employee mandatory photo updates...');
  await uploadFile(
    'apps/web/src/pages/DriverApplicationPage.jsx',
    'apps/web/src/pages/DriverApplicationPage.jsx',
    'feat: make passport photo mandatory for all employee, staff, and driver applicants'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for mandatory staff photo update');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-DS-XFDnF.js', 'dist/apps/web/assets/index-DS-XFDnF.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ All mandatory staff photo files uploaded!');
}

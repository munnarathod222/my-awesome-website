...
async function main() {
  console.log('Uploading canonical employee code parity engine (D001, D002, E001)...');
  await uploadFile(
    'apps/web/src/lib/employeeCodeUtils.js',
    'apps/web/src/lib/employeeCodeUtils.js',
    'feat: create universal employeeCodeUtils.js for 100% identical code matching'
  );
  await uploadFile(
    'apps/web/src/pages/EmployeeDatabasePage.jsx',
    'apps/web/src/pages/EmployeeDatabasePage.jsx',
    'fix: use getCanonicalEmployeeCode in EmployeeDatabasePage table rows'
  );
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'fix: use getCanonicalEmployeeCode in IdCardGeneratorPage directory sync'
  );
  await uploadFile(
    'apps/web/src/pages/EmployeeQRVerificationPage.jsx',
    'apps/web/src/pages/EmployeeQRVerificationPage.jsx',
    'fix: use getCanonicalEmployeeCode in EmployeeQRVerificationPage'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for canonical code parity');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-B9kndKEA.js', 'dist/apps/web/assets/index-B9kndKEA.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ Canonical employee code parity fix uploaded!');
}

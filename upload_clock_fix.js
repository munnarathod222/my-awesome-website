...
async function main() {
  console.log('Uploading missing Clock icon import fix in GstITCManagerPage...');
  await uploadFile(
    'apps/web/src/pages/GstITCManagerPage.jsx',
    'apps/web/src/pages/GstITCManagerPage.jsx',
    'fix: add missing Clock icon import in GstITCManagerPage to fix rendering error'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for Clock icon import fix');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-Cu_HGtzx.js', 'dist/apps/web/assets/index-Cu_HGtzx.js', 'chore: update dist JS bundle');

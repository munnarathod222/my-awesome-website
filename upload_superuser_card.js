...
async function main() {
  console.log('Uploading Super User ID Card & removing fake dummy data...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'feat: remove dummy employees and add dedicated Super User card in ID Card Studio'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for super user card');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-Dd353UzL.js', 'dist/apps/web/assets/index-Dd353UzL.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ Super User Card & Clean Directory uploaded!');
}

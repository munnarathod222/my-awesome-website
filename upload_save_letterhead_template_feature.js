...
async function main() {
  console.log('Uploading Save Letterhead Template Feature...');
  await uploadFile(
    'apps/web/src/pages/OfficialLetterheadPage.jsx',
    'apps/web/src/pages/OfficialLetterheadPage.jsx',
    'feat: add save custom letterhead template system and quick load manager'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for save template feature');
  console.log('Uploading JS bundle (5.0MB)...');
  await uploadFile('dist/apps/web/assets/index-BOGwovbG.js', 'dist/apps/web/assets/index-BOGwovbG.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-Uzqsb5oU.css', 'dist/apps/web/assets/index-Uzqsb5oU.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Save Letterhead Template feature uploaded successfully!');
}

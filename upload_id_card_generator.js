...
async function main() {
  console.log('Uploading Employee & Driver ID Card Generator feature...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'feat: create Employee & Driver ID Card Generator page with templates & QR verification'
  );
  await uploadFile(
    'apps/web/src/App.jsx',
    'apps/web/src/App.jsx',
    'feat: register /id-card-generator route in App.jsx'
  );
  await uploadFile(
    'apps/web/src/components/Sidebar.jsx',
    'apps/web/src/components/Sidebar.jsx',
    'feat: add ID Card Generator link under Fleet & Staff in Sidebar'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for ID Card Generator');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-De7-j05W.js', 'dist/apps/web/assets/index-De7-j05W.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-GixofpdN.css', 'dist/apps/web/assets/index-GixofpdN.css', 'chore: update dist CSS bundle');

  console.log('\n✅ ID Card Generator feature uploaded!');
}

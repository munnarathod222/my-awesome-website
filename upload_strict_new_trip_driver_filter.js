...
async function main() {
  console.log('Uploading Strict Active Drivers Filter for New Trips...');
  await uploadFile(
    'apps/web/src/components/AddTripModal.jsx',
    'apps/web/src/components/AddTripModal.jsx',
    'fix: ensure strictly only active drivers are loaded in AddTripModal dropdown'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for strict driver filter');
  console.log('Uploading JS bundle...');
  await uploadFile('dist/apps/web/assets/index-DKWMHIcM.js', 'dist/apps/web/assets/index-DKWMHIcM.js', 'chore: update dist JS bundle');

  console.log('\n✅ Strict Active Drivers Filter uploaded successfully!');
}

...
async function main() {
  console.log('Uploading Insurance Helpline & QR verification updates...');
  await uploadFile(
    'apps/web/src/pages/TruckDocsPage.jsx',
    'apps/web/src/pages/TruckDocsPage.jsx',
    'feat: add insurance claim helpline number field to document upload form'
  );
  await uploadFile(
    'apps/web/src/pages/VehicleQRVerificationPage.jsx',
    'apps/web/src/pages/VehicleQRVerificationPage.jsx',
    'feat: display insurance helpline card and call action on scanned vehicle QR page'
  );
  await uploadFile(
    'apps/web/src/components/DocumentPreviewModal.jsx',
    'apps/web/src/components/DocumentPreviewModal.jsx',
    'feat: render insurance helpline banner in document preview modal'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for insurance helpline update');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-CKvNmwF0.js', 'dist/apps/web/assets/index-CKvNmwF0.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ All Insurance Helpline files uploaded!');
}

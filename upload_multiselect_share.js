...
async function main() {
  ...
  await uploadFile(
    ...
    'apps/web/src/pages/ContactsPage.jsx',
    'feat: sticky multi-select floating action bar for batch sharing contacts'
  );
  await uploadFile(
    'apps/web/src/components/TransportCrmWhatsAppShareModal.jsx',
    'apps/web/src/components/TransportCrmWhatsAppShareModal.jsx',
    'feat: support directory card sharing in WhatsApp modal'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist for multi-select contact sharing');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-DWJfasWL.js', 'dist/apps/web/assets/index-DWJfasWL.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ All multi-select contact sharing features uploaded!');
}

...
async function main() {
  console.log('Uploading Vertical ID Card Studio & Template Picker Gallery...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'feat: enhance ID Card Generator Studio with vertical lanyard templates & visual template picker'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for vertical ID card templates');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-DhYKfg4f.js', 'dist/apps/web/assets/index-DhYKfg4f.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-BVkRwm9r.css', 'dist/apps/web/assets/index-BVkRwm9r.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Vertical ID Card templates feature uploaded!');
}

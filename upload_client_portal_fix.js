...
async function main() {
  console.log('Uploading Client Portal data population & non-empty page fix...');
  await uploadFile(
    'apps/web/src/pages/ClientPortalPage.jsx',
    'apps/web/src/pages/ClientPortalPage.jsx',
    'fix: ensure client portal dashboard always populates data after logging in'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for client portal fix');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-BcweJtzO.js', 'dist/apps/web/assets/index-BcweJtzO.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-B5G2eECU.css', 'dist/apps/web/assets/index-B5G2eECU.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Client Portal page population fix uploaded!');
}

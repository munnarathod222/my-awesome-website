...
async function main() {
  ...
  await uploadFile(
    'apps/web/src/components/TruckFormModal.jsx',
    'apps/web/src/components/TruckFormModal.jsx',
    'feat: add truck size options (14-32FT), payload capacity, and L×W×H dimensions'
  );
  await uploadFile(
    'apps/web/src/pages/TruckManagerPage.jsx',
    'apps/web/src/pages/TruckManagerPage.jsx',
    'feat: show payload capacity and body dimensions badges on truck cards'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist for truck config fields');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-Cfb9bFcX.js', 'dist/apps/web/assets/index-Cfb9bFcX.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-BsskM2sC.css', 'dist/apps/web/assets/index-BsskM2sC.css', 'chore: update dist CSS bundle');

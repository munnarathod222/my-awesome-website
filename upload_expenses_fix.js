...
async function main() {
  console.log('Uploading source file ExpensesPage.jsx...');
  await uploadFile(
    'apps/web/src/pages/ExpensesPage.jsx',
    'apps/web/src/pages/ExpensesPage.jsx',
    'fix: restore isBulkProcessingAdvances state variable in ExpensesPage'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist for isBulkProcessingAdvances fix');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-DY4o2FHP.js', 'dist/apps/web/assets/index-DY4o2FHP.js', 'chore: update dist JS bundle');

...
async function main() {
  console.log('Uploading Custom Letterhead Upload (PDF/Image) & Alignment Sliders Feature...');
  await uploadFile(
    'apps/web/src/pages/OfficialLetterheadPage.jsx',
    'apps/web/src/pages/OfficialLetterheadPage.jsx',
    'feat: add custom letterhead PDF/Image background upload and margin sliders'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for custom letterhead upload feature');
  console.log('Uploading JS bundle (5.0MB)...');
  await uploadFile('dist/apps/web/assets/index-CIuhgaLW.js', 'dist/apps/web/assets/index-CIuhgaLW.js', 'chore: update dist JS bundle');
  ...
  console.log('\n✅ Custom Letterhead Upload feature uploaded successfully!');
}

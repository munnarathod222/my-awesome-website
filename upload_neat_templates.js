...
async function main() {
  console.log('Uploading ultra-neat ID card template designs...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'style: overhaul ID card templates with ultra-neat glassmorphism & crisp typography'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for ultra-neat template designs');
  console.log('Uploading JS bundle (4.9MB)...');
  await uploadFile('dist/apps/web/assets/index-Bn7kqadV.js', 'dist/apps/web/assets/index-Bn7kqadV.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-BYT73ZLf.css', 'dist/apps/web/assets/index-BYT73ZLf.css', 'chore: update dist CSS bundle');

  console.log('\n✅ Ultra-neat ID card templates uploaded!');
}

...
async function main() {
  ...
  await uploadFile(
    'apps/web/src/pages/ContactsPage.jsx',
    'apps/web/src/pages/ContactsPage.jsx',
    'feat: separate Truck Owners, Transporters, Maintenance Network, Corporate Clients, Drivers, Finance & Other tabs'
  );
  await uploadFile(
    'apps/web/src/components/ContactFormModal.jsx',
    'apps/web/src/components/ContactFormModal.jsx',
    'feat: support Truck Owner and Transporter contact types in form'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist for organized contacts');
  console.log('Uploading JS bundle (4.8MB)...');
  await uploadFile('dist/apps/web/assets/index-D7nCU_9i.js', 'dist/apps/web/assets/index-D7nCU_9i.js', 'chore: update dist JS bundle');
  console.log('Uploading CSS bundle...');
  await uploadFile('dist/apps/web/assets/index-D65d70o8.css', 'dist/apps/web/assets/index-D65d70o8.css', 'chore: update dist CSS bundle');

  console.log('\n✅ All organized contact updates uploaded!');
}

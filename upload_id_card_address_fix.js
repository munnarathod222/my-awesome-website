...
async function main() {
  console.log('Uploading ID Card Address Fix...');
  await uploadFile(
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'apps/web/src/pages/IdCardGeneratorPage.jsx',
    'fix: update company address on ID cards to pull dynamically from company settings'
  );

  console.log('\nUploading dist files...');
  await uploadFile('dist/apps/web/index.html', 'dist/apps/web/index.html', 'chore: update dist index.html for ID card address fix');
  console.log('Uploading JS bundle...');
  await uploadFile('dist/apps/web/assets/index-MGDr8_yU.js', 'dist/apps/web/assets/index-MGDr8_yU.js', 'chore: update dist JS bundle');

  console.log('\n✅ ID Card Address Fix uploaded successfully!');
}
